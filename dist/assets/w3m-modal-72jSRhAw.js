import{dH as x,eb as ae,d6 as c,d8 as de,cT as $,cU as L,cX as w,cY as y,cZ as d,cW as l,dp as W,dh as _,dB as u,cV as ue,c$ as D,dd as g,dz as j,e6 as he,dN as V,da as U,dE as R,dl as F,d2 as pe,d7 as O,dJ as z,e3 as ee,dA as me,d1 as ne,ec as fe}from"./index-B4Jp5nYj.js";import"./index-H-bTk396.js";import{S as we}from"./SwapController-B12vZR9B.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},be=$`
  :host {
    display: block;
...
`;var M=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let T=class extends y{constructor(){super(...arguments),this.message="",this.variant="success"}render(){return d`
    ...
    `}templateIcon(){const t={success:"success",error:"error",warning:"warning",info:"default"},i={success:"checkmark",error:"warning",warning:"warningCircle",info:"info"};return this.variant==="loading"?d`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:d`<wui-icon-box
      ...
      icon=${i[this.variant]}
    ></wui-icon-box>`}};T.styles=[L,Re];M([l()],T.prototype,"message",void 0);M([l()],T.prototype,"variant",void 0);T=M([w("wui-snackbar")],T);const Oe=pe`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
