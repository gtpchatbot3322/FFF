import{cT as O,cW as W,dB as l,cX as _,cY as I,dl as P,dE as h,dJ as T,d6 as f,dj as F,cZ as c,dK as D,df as C,dL as N,dh as j,dM as A,dp as y,dd as d,d8 as S,dN as M,da as u,dO as U,d7 as v,dP as z,dH as R,dA as E}from"./index-B4Jp5nYj.js";const B=O`
  :host {
...
`;var g=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let p=class extends I{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=P.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=h.state.remoteFeatures,this.isPwaLoading=!1,this.hasExceededUsageLimit=T.state.plan.hasExceededUsageLimit,this.unsubscribe.push(P.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(o=>o.type==="AUTH")}),h.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var i;let e=((i=this.remoteFeatures)==null?void 0:i.socials)||[];const o=!!this.authConnector,r=e==null?void 0:e.length,n=f.state.view==="ConnectSocials";return(!o||!r)&&!n?null:(n&&!r&&(e=F.DEFAULT_SOCIALS),c` <wui-flex flexDirection="column" gap="2">
      ${e.map(s=>c`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){if(this.hasExceededUsageLimit){f.push("UsageExceeded");return}e&&await D(e)}async handlePwaFrameLoad(){var e;if(C.isPWA()){this.isPwaLoading=!0;try{((e=this.authConnector)==null?void 0:e.provider)instanceof N&&await this.authConnector.provider.init()}catch(o){j.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:o.message},"error")}finally{this.isPwaLoading=!1}}}};p.styles=B;g([W()],p.prototype,"tabIdx",void 0);g([l()],p.prototype,"connectors",void 0);g([l()],p.prototype,"authConnector",void 0);g([l()],p.prototype,"remoteFeatures",void 0);g([l()],p.prototype,"isPwaLoading",void 0);g([l()],p.prototype,"hasExceededUsageLimit",void 0);p=g([_("w3m-social-login-list")],p);const q=O`
  wui-flex {
...
`;var k=function(t,e,o,r){var n=arguments.length,i=n<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,o):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(t,e,o,r);else for(var a=t.length-1;a>=0;a--)(s=t[a])&&(i=(n<3?s(i):n>3?s(e,o,i):s(e,o))||i);return n>3&&i&&Object.defineProperty(e,o,i),i};let L=class extends I{constructor(){super(),this.unsubscribe=[],this.checked=A.state.isLegalCheckboxChecked,this.unsubscribe.push(A.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var $;const{termsConditionsUrl:e,privacyPolicyUrl:o}=h.state,r=($=h.state.features)==null?void 0:$.legalCheckbox,s=!!(e||o)&&!!r&&!this.checked,a=s?-1:void 0;return c`
    ...
    `}};L.styles=q;k([l()],L.prototype,"checked",void 0);L=k([_("w3m-connect-socials-view")],L);const G=O`
  wui-logo {
    width: 80px;
    height: 80px;
