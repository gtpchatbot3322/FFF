import{cT as A,dB as l,cW as w,cX as D,cY as C,dd as $,d3 as h,cZ as u,dj as V,da as N,d6 as S,df as M,dH as K,db as F,dc as Q,cU as W,cV as H,e7 as _}from"./index-B4Jp5nYj.js";import{S as s}from"./SwapController-B12vZR9B.js";import"./index-Czl80AQz.js";const q={numericInputKeyDown(e,t,o){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=e.metaKey||e.ctrlKey,n=e.key,a=n.toLocaleLowerCase(),c=a==="a",b=a==="c",I=a==="v",L=a==="x",E=n===",",R=n===".",B=n>="0"&&n<="9";!r&&(c||b||I||L)&&e.preventDefault(),t==="0"&&!E&&!R&&n==="0"&&e.preventDefault(),t==="0"&&B&&(o(n),e.preventDefault()),(E||R)&&(t||(o("0."),e.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&e.preventDefault()),!B&&!i.includes(n)&&!R&&!E&&e.preventDefault()}},G=A`
  :host {
    width: 100%;
  }
...
`;var U=function(e,t,o,i){var r=arguments.length,n=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,o):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,o,i);else for(var c=e.length-1;c>=0;c--)(a=e[c])&&(n=(r<3?a(n):r>3?a(t,o,n):a(t,o))||n);return r>3&&n&&Object.defineProperty(t,o,n),n};let P=class extends C{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(o=>{o.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){var o;if(!this.visible)return null;const t=this.amount&&this.price?(o=h.multiply(this.price,this.amount))==null?void 0:o.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};P.styles=[W,H,oe];U([w()],P.prototype,"imageSrc",void 0);U([w()],P.prototype,"name",void 0);U([w()],P.prototype,"symbol",void 0);U([w()],P.prototype,"price",void 0);U([w()],P.prototype,"amount",void 0);U([l()],P.prototype,"visible",void 0);U([l()],P.prototype,"imageError",void 0);P=U([D("wui-token-list-item")],P);const ie=A`
  :host {
    width: 100%;
  }
